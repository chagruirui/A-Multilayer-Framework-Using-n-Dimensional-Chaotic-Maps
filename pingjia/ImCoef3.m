...
figure();
plot(u1,v1,'b.','linewidth',3,'markersize',10);
axis([0 250 0 250]);
...
xlabel('\bf \itPixel gray value on location(\itx\rm,\ity\rm)');
ylabel('\bf \itPixel gray value on location(\itxrm+1,\ity\rm)');
figure();
plot(u2,v2,'b.','linewidth',3,'markersize',10);
axis([0 250 0 250]);
set(gca,'XTick',0:50:250,'YTick',0:50:250,'fontsize',18,'fontname','times new roman');
set(gca,'XTickLabel',{'0','50','100','150','200','250'}); 
set(gca,'YTickLabel',{'0','50','100','150','200','250'}); 
...
ylabel('\bf \itPixel gray value on location(\itxrm+1,\ity\rm)');
figure();
plot(u3,v3,'b.','linewidth',3,'markersize',10);
axis([0 250 0 250]);
set(gca,'XTick',0:50:250,'YTick',0:50:250,'fontsize',18,'fontname','times new roman');
set(gca,'XTickLabel',{'0','50','100','150','200','250'}); 
set(gca,'YTickLabel',{'0','50','100','150','200','250'}); 
...
ylabel('\bf \itPixel gray value on location(\itxrm+1,\ity\rm)');
figure();
plot(u4,v4,'b.','linewidth',3,'markersize',10);
axis([0 250 0 250]);
set(gca,'XTick',0:50:250,'YTick',0:50:250,'fontsize',18,'fontname','times new roman');
set(gca,'XTickLabel',{'0','50','100','150','200','250'}); 
set(gca,'YTickLabel',{'0','50','100','150','200','250'}); 
