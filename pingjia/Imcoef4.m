...
axis([0 250 0 250]);
set(gca,'XTick',0:50:250,'YTick',0:50:250,'fontname','times new roman');
set(gca,'XTickLabel',{'0','50','100','150','200','250'});
set(gca,'YTickLabel',{'0','50','100','150','200','250'});
xlabel('\bf \it Piexl gray value on location(\itx\rm,\ity\rm)');
ylabel('\bf \it Piexl gray value on location(\itx\rm + 1,\ity\rm)');
% 垂直
figure;
...
set(gca,'YTickLabel',{'0','50','100','150','200','250'});
xlabel('\bf \it Piexl gray value on location(\itx\rm,\ity\rm)');
ylabel('\bf \it Piexl gray value on location(\itx\rm,\ity\rm + 1)');
% 正对角线
figure;
...
set(gca,'YTickLabel',{'0','50','100','150','200','250'});
xlabel('\bf \it Piexl gray value on location(\itx\rm,\ity\rm)');
ylabel('\bf \it Piexl gray value on location(\itx\rm + 1,\ity\rm + 1)');
% 反对角线
figure;
...
set(gca,'YTickLabel',{'0','50','100','150','200','250'});
xlabel('\bf \it Piexl gray value on location(\itx\rm,\ity\rm)');
ylabel('\bf \itPiexl gray value on location(\itx\rm - 1,\ity\rm + 1)');
end