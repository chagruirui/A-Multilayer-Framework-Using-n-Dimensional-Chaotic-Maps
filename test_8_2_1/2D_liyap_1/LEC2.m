...
J0 = [                                                    -(8*pi^2*sin(a*y(1) + (8*pi*sin(pi*x(1)))/b)*cos(pi*x(1)))/b,                                                                                        -a*sin(a*y(1) + (8*pi*sin(pi*x(1)))/b);
         -8*pi^2*cos(b*cos(a*y(1) + (8*pi*sin(pi*x(1)))/b) + 2*a*pi*y(1)*(y(1) - 1))*sin(a*y(1) + (8*pi*sin(pi*x(1)))/b)*cos(pi*x(1)), cos(b*cos(a*y(1) + (8*pi*sin(pi*x(1)))/b) + 2*a*pi*y(1)*(y(1) - 1))*(2*a*pi*(y(1) - 1) - a*b*sin(a*y(1) + (8*pi*sin(pi*x(1)))/b) + 2*a*pi*y(1))];
